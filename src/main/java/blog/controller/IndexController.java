...
import blog.utils.IPKit;
import blog.utils.PatternKit;
...
public class IndexController extends BaseController
{
    ...
    public String getArticle(HttpServletRequest request, @PathVariable String cid)
    {
        ...
        {
            System.out.println(" @GetMapping(value = {\"article/{cid}\", \"article/{cid}.html\"})");
    ...
    public String articlePreview(HttpServletRequest request, @PathVariable String cid)
    {
        ...
        if (null == contents)
        {
            System.out.println("@GetMapping(value = {\"article/{cid}/preview\", \"article/{cid}.html\"})");
            return this.render_404();
        }
        request.setAttribute("article", contents);
        request.setAttribute("is_post", true);
    ...
    public RestResponseBo comment(HttpServletRequest request, HttpServletResponse response, @RequestParam Integer cid, @RequestParam Integer coid, @RequestParam String author, @RequestParam String mail, @RequestParam String url, @RequestParam String text, @RequestParam String _csrf_token)
    {
    ...
    public String categories(HttpServletRequest request, @PathVariable String keyword, @PathVariable int page, @RequestParam(value = "limit", defaultValue = "12") int limit)
    {
        ...
        if (null == metaDto)
        {
            System.out.println("@GetMapping(value = \"category/{keyword}/{page}\")");
            return this.render_404();
        }
    ...
    public String page(@PathVariable String pagename, HttpServletRequest request)
    {
        ...
        if (null == contents)
        {
            System.out.println("  @GetMapping(value = \"/{pagename}\")");
            return this.render_404();
        }
        if (contents.getAllowComment())
        {
    ...
    public String tags(HttpServletRequest request, @PathVariable String name, @PathVariable int page, @RequestParam(value = "limit", defaultValue = "12") int limit)
    {
        ...
        if (null == metaDto)
        {
            System.out.println("@GetMapping(value = \"tag/{name}/{page}\")");
            return this.render_404();
        }
