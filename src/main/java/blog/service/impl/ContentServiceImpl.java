...
import blog.service.RelationshipService;
...
public class ContentServiceImpl implements ContentService
{
    ...
    public ContentVo getContents(String id)
    {
        ...
        } else
        {
            ...
            if (contentVos.size() != 1) throw new TipException("query content by id and return is not one");
    ...
    {
        if (contentVo != null && contentVo.getCid() != null) contentDao.updateByPrimaryKeySelective(contentVo);
    }
